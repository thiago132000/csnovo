      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
         ...
         <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu shadow" aria-labelledby="navbarDropdownMenuLink" style="margin-top: -1px;">
          <a class="dropdown-item" href="caixa"><i class="fas fa-dollar-sign iconesMenu mr-3 ml-1"></i>Caixa</a>
          <div class="dropdown-divider"></div>
           <a class="dropdown-item" href="venda"><i class="fas fa-hand-holding-usd iconesMenu mr-3"></i>Realizar Venda</a>
           <div class="dropdown-divider"></div>
           <a class="dropdown-item" href="listagem_total_venda"><i class="fas fa-chart-line iconesMenu mr-3"></i>Listar Vendas</a>
       ...
       <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu shadow" aria-labelledby="navbarDropdownMenuLink" style="margin-top: -1px;">
        <a class="dropdown-item" href="ajustes"><i class="fas fa-wrench iconesMenu mr-3"></i>Ajustes</a>
        <div class="dropdown-divider"></div>
...
<a class="nav-link active casa" id="carrinho" href="venda"><i class="fas fa-shopping-cart ml-4 text-white" style="transform: scale(1.4);"><span class="ml-2 align-middle" style="font-size: 8px; font-family: 'Monda', sans-serif;"><?php echo $atalhoC; ?> itens</span></i><span class="sr-only">(current)</span></a>
