  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="min-width: 500px; border-radius: 10px;">
      <div class="modal-header rounded-top" style="border-radius: 15px 15px 10px 10px">
        <h5 class="modal-title text-white" id="exampleModalCenterTitle"><i class="far fa-question-circle text-white mr-3 ml-4" style="transform: scale(1.2);"></i><?php echo $tituloModal2; ?></h5>
      ...
      <div class="modal-body text-dark text-left" style="transform: scale(1.3); <?php echo $padding2; ?>">
    	<?php echo $textoModal2; ?>
      </div>
