...
if (empty($nome)) {
	...
	$descA = 'Nome do produto está em branco!';

	include '../includes/alerta.php';

	$_SESSION['msg'] = $alertaSess;

	header('location: ../cadastra_produto');

} else {

	require '../banco/conexao.php';

	$stmt = $conn->prepare("INSERT INTO produto (nome_prod) VALUES(?)");
	...
	$acao = 'Cadastrou um produto com o nome ' . $nome;
	...
	$descA = 'Produto cadastrado com sucesso!';
