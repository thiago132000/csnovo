...
//busca nome do fornecedor antes de excluir
...
//fim da busca de nome
	...
	mysqli_query($conn, "DELETE FROM fornecedor WHERE id_for='$excluir'");

	$conn->close();

	$acao = 'Deletou o fornecedor ' . $nomeFor;
	...
	$descA = 'Fornecedor excluído com sucesso!';

	include '../includes/alerta.php';

	$_SESSION['msg'] = $alertaSess;

	header("location: ../listagem_total_forne&pagina=" . $paginaR);
